...
<aside class="sidebar fixed h-full bg-white flex flex-col border-r border-slate-200 shadow-xl z-10" id="sidebar" aria-label="Sidebar navigation" style="width: 320px;">
    <div class="p-8">
